...
PR  создан успешно.
https://github.com/vegorshkov/netology-terraform-dz5/pull/1

Мерджим в main.

Задание 4 "Напишите переменные с валидацией и протестируйте их, заполнив default верными и неверными значениями."

Создаем новую ветку для задания #4
![alt text](image-50.png)

У нас не прошел план так как теги поменялись, создаем следующий.
![alt text](image-51.png)

Проверяем работу проверки IP.
...
Валидация проверка работают.

Задание 5*  "Написать переменные с валидацией"

Проверка валидации:

Команда:
terraform plan -var='in_the_end_there_can_be_only_one={Dunkan=true,Connor=false}'
проверка проходит.

Команда:
terraform plan -var='in_the_end_there_can_be_only_one={Dunkan=false,Connor=false}'

![alt text](image-55.png)

Команда:
terraform plan -var='in_the_end_there_can_be_only_one={Dunkan=true,Connor=true}'

![alt text](image-56.png)


Задание 6*  "Настройте любую известную вам CI/CD-систему. Если вы ещё не знакомы с CI/CD-системами, настоятельно рекомендуем вернуться к этому заданию после изучения Jenkins/Teamcity/Gitlab."
